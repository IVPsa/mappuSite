      ...
      <div class="modal-body"style="min-height:435px;">
        ...
        <div class="row" align="center">
          <div class="col-xs-12 col-md-4">
            <img src="images/nosotros.png"  height="75%" width="75%" class="img-fluid" />
          </div>
        ...
        <div align="center" style="">
          <a href="{{route('vermas.vermas-aplicaciones-mAppu')}}"><input type="button" class="verMas"value="Ver más"></a>
        </div>
