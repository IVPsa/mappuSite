		...
		<div class="row">
			...
			<div class="col-md-12 col-xs-12">
				<div style="margin:15px 15px 15px 15px;">
					<h3>¿Qué es una Aplicacion web?</h3>
					<p class="text-justify">
						Las aplicaciones web son herramientas informáticas que se alojas en sitios web, permitiendo su acceso desde cualquier dispositivo, como notebook, Tablet o Smartphone que cuente con un navegador de internet.
					</p>
					<center>
            <img class="img-fluid" src="images/App-web.png" alt="imagen asesoria">
